...
export async function uploadBlob({ blob }: { blob: Blob }) {
	...
	console.log('[uploadBlob] posting blob, size:', blob.size, 'type:', blob.type, 'did:', user.did);
	...
	console.log('[uploadBlob] response ok:', blobResponse?.ok, 'data:', blobResponse?.data);
